...
export const translations = {
  en: {
    ...
    auth: {
      ...
      googleDescription: "Use your approved Google account to access the dashboard.",
      ...
      loginError: {
        ...
        notAllowed: "This Google account is not allowed",
        notLinked: "This Google account is not linked yet. Sign in locally first, then connect Google.",
    ...
    host: {
      ...
      dockerResourceHistory: "Docker Resource History",
    ...
    dockerGrid: {
      noContainers: "No containers detected",
      noFilterMatches: "No containers match this filter",
      standalone: "Standalone",
      total: "{count} containers",
      running: "{count} running",
      attention: "{count} need attention",
      groupTotal: "{count} containers in this stack",
      groupRunning: "{running}/{total} running",
      exitCode: "exit {code}",
      restarts: "restarts {count}",
    },
    // CpuCoreGrid
    ...
    notifications: {
      ...
      description: "Connect the tools your team already watches, then send a quick test before relying on them.",
      ...
      enabled: "On",
      disabled: "Off",
      discordDescription: "Fast team chat delivery.",
      slackDescription: "Route alerts into an ops channel.",
      emailDescription: "Plain-text SMTP backup.",
      teamsDescription: "Microsoft Teams incoming webhook.",
      telegramDescription: "Mobile-first bot notification.",
      webhookDescription: "POST JSON into automation tools.",
      testSend: "Test",
      testSuccess: "Test sent successfully",
      testFailed: "Test failed",
      noChannels: "No notification channels configured.",
      noChannelsDescription: "Add Teams, Telegram, webhook, Slack, Discord, or email to start routing incidents.",
    },
    // Status page
    statusPage: {
  ...
  ko: {
    ...
    auth: {
      ...
      googleDescription: "승인된 Google 계정으로 대시보드에 접속합니다.",
      ...
      loginError: {
        ...
        oauth: "Google 로그인을 완료할 수 없습니다",
        notAllowed: "허용되지 않은 Google 계정입니다",
        notLinked: "아직 연동되지 않은 Google 계정입니다. 먼저 로컬 계정으로 로그인한 뒤 Google을 연결하세요.",
        oauthConflict: "이 Google 계정은 이미 다른 사용자에게 연결되어 있습니다",
    ...
    host: {
      ...
      dockerResourceHistory: "Docker 리소스 이력",
      diskUsage: "디스크 사용량",
    ...
    dockerGrid: {
      noContainers: "감지된 컨테이너 없음",
      noFilterMatches: "이 필터에 맞는 컨테이너가 없습니다",
      standalone: "Standalone",
      total: "컨테이너 {count}개",
      running: "실행 중 {count}개",
      attention: "주의 {count}개",
      groupTotal: "이 스택에 컨테이너 {count}개",
      groupRunning: "{running}/{total} 실행 중",
      exitCode: "exit {code}",
      restarts: "재시작 {count}회",
    },
    cpuCores: {
    ...
    notifications: {
      title: "알림 채널",
      description: "팀이 이미 보고 있는 도구를 연결하고, 실제 운영 전에 테스트 전송으로 확인하세요.",
      addChannel: "채널 추가",
      channelName: "이름",
      channelType: "유형",
      webhookUrl: "Webhook URL",
      ...
      enabled: "켜짐",
      disabled: "꺼짐",
      discordDescription: "팀 채팅으로 빠르게 전달합니다.",
      slackDescription: "운영 채널로 알림을 보냅니다.",
      emailDescription: "SMTP 기반 백업 알림입니다.",
      teamsDescription: "Microsoft Teams webhook 연동입니다.",
      telegramDescription: "모바일 우선 봇 알림입니다.",
      webhookDescription: "자동화 도구로 JSON을 POST합니다.",
      testSend: "테스트",
      testSuccess: "테스트 전송 성공",
      testFailed: "테스트 실패",
      noChannels: "설정된 알림 채널이 없습니다.",
      noChannelsDescription: "Teams, Telegram, Webhook, Slack, Discord, Email 중 하나를 추가해 장애 라우팅을 시작하세요.",
    },
    statusPage: {
      title: "서비스 상태",
